...
private:
    ...
    int getIndexOfChunk (std::vector<uint8_t>& source, std::string const& chunkHeaderID, int startIndex, Endianness endianness = Endianness::LittleEndian);
...
//=============================================================
//template <class T>
//int AudioFile<T>::getIndexOfChunk (std::vector<uint8_t>& source, std::string const& chunkHeaderID, int startIndex, Endianness endianness)
//{
