...
namespace Volund
{
    ...
    #ifdef VOLUND_BUILD
        template class VOLUND_API Vector<2, float>;
        template class VOLUND_API Vector<2, double>;
        template class VOLUND_API Vector<2, int32_t>;
        template class VOLUND_API Vector<2, int64_t>;
    #else
        extern template class VOLUND_API Vector<2, float>;
        extern template class VOLUND_API Vector<2, double>;
        extern template class VOLUND_API Vector<2, int32_t>;
        extern template class VOLUND_API Vector<2, int64_t>;
    #endif
