...
void main()
{   
    vec3 Albedo = texture(AlbedoTexture, FragTextureCoord).rgb;
    float Roughness = texture(MetalTexture, FragTextureCoord).r;
    float Metalness = texture(RoughTexture, FragTextureCoord).r;
