...
namespace Volund
{
    ...
    LuaState::LuaState(std::string const& cwd)
    {
        ...
        this->m_state.new_usertype<Vec2>("Vec2", 
        ...
        this->m_state.new_usertype<Vec3>("Vec3", 
        ...
        this->m_state.new_usertype<Vec4>("Vec4", 
        ...
        // Mat4x4 Usertype
        this->m_state.new_usertype<Mat4x4>("Mat4x4", 
            sol::constructors<
                Mat4x4(), 
                Mat4x4(float), 
        ...
        this->m_state.new_usertype<AudioBuffer>("AudioBuffer", sol::constructors<AudioBuffer(std::string const&)>());
        ...
        this->m_state.new_usertype<Transform>("Transform", 
        ...
        this->m_state.new_usertype<PointLight>("PointLight", 
            sol::constructors<PointLight(Vec3, float)>(),
            "color", &PointLight::color,
            "brightness", &PointLight::brightness
        );

        this->m_state.new_usertype<MeshRenderer>("MeshRenderer", 
        ...
        this->m_state.new_usertype<CameraMovement>("CameraMovement", 
